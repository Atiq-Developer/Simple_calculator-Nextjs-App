...
export default function Calculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gray-700 dark:bg-gray-900">
      {/* Center the calculator within the screen */}
      <Card className="w-full max-w-md p-6 bg-blue-50 dark:bg-gray-800 shadow-lg rounded-lg">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-2">
            <Button
              variant="outline"
              className="text-2xl font-bold text-gray-700 dark:text-gray-300 border-gray-300"
              onClick={add}
            >
              +
            </Button>
